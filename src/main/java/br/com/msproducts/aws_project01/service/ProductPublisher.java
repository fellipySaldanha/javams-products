package br.com.msproducts.aws_project01.service;

import br.com.msproducts.aws_project01.enums.EventType;
import br.com.msproducts.aws_project01.model.EventWrapper;
import br.com.msproducts.aws_project01.model.Product;
import br.com.msproducts.aws_project01.model.ProductEvent;
...
public class ProductPublisher {
    ...
    public void publishProductEvent(Product product, EventType eventType, String username) {
        ...
        try {
            eventWrapper.setData(objectMapper.writeValueAsString(productEvent));

            snsClient.publish(
                    productEventsTopic.getTopicArn(),
                    objectMapper.writeValueAsString(eventWrapper));
